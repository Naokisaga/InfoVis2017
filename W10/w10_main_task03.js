function main()
{
    ...
    var C0 = new THREE.Color().setHex( cmap[ Math.round((scalars[0]-0.1)/(0.8-0.1) * 255) ][1] );
    var C1 = new THREE.Color().setHex( cmap[ Math.round((scalars[1]-0.1)/(0.8-0.1) * 255) ][1] );
    var C2 = new THREE.Color().setHex( cmap[ Math.round((scalars[2]-0.1)/(0.8-0.1) * 255) ][1] );

    var C3 = new THREE.Color().setHex( cmap[ Math.round((scalars[3]-0.1)/(0.8-0.1) * 255) ][1] );
    if (i==0){
